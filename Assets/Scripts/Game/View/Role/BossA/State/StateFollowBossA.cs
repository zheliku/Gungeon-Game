...
namespace Game
{
    ...
    public class StateFollowBossA : AbstractState<BossA.State, BossA>
    {
        public float FollowSeconds;

        public StateFollowBossA(FSM<BossA.State> fsm, BossA owner) : base(fsm, owner)
        { }
        ...
        protected override void OnUpdate()
        {
            ...
            {
                _fsm.ChangeState(BossA.State.PrepareToShoot);
            }
        }
    }
}
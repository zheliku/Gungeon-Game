...
namespace Game
{
    ...
    public class BossC : Boss
    {
        ...
        protected override void Awake()
        {
            ...
            FSM.AddState(State.Follow, new StateFollowBossC(FSM, this));
            FSM.AddState(State.PrepareToShoot, new StatePrepareToShootBossC(FSM, this));
            FSM.AddState(State.Shoot, new StateShootBossC(FSM, this));

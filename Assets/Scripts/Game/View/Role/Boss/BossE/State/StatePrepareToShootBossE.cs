...
namespace Game
{
    ...
    public class StatePrepareToShootBossE : AbstractState<BossE.State, BossE>
    {
        private Vector2 _onEnterPrepareToShootLocalPos;
            

        public StatePrepareToShootBossE(FSM<BossE.State> fsm, BossE owner) : base(fsm, owner)
        { }
        ...
        protected override void OnUpdate()
        {
            ...
            {
                _fsm.ChangeState(BossE.State.Shoot);
            }
        }

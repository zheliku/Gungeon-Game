...
namespace Game
{
    ...
    public class StatePrepareToShootBossA : AbstractState<BossA.State, BossA>
    {
        private Vector2 _onEnterPrepareToShootLocalPos;
            

        public StatePrepareToShootBossA(FSM<BossA.State> fsm, BossA owner) : base(fsm, owner)
        { }
        ...
        protected override void OnUpdate()
        {
            ...
            {
                _fsm.ChangeState(BossA.State.Shoot);
            }
        }

...
namespace Game
{
    ...
    public class StateFollowBossD : AbstractState<BossD.State, BossD>
    {
        public float FollowSeconds;

        public StateFollowBossD(FSM<BossD.State> fsm, BossD owner) : base(fsm, owner)
        { }
        ...
        protected override void OnUpdate()
        {
            ...
            {
                _fsm.ChangeState(BossD.State.PrepareToShoot);
            }
        }
    }
}
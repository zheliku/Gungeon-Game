...
namespace Game
{
    ...
    public class StateFollowBossE : AbstractState<BossE.State, BossE>
    {
        public float FollowSeconds;

        public StateFollowBossE(FSM<BossE.State> fsm, BossE owner) : base(fsm, owner)
        { }
        ...
        protected override void OnUpdate()
        {
            ...
            {
                _fsm.ChangeState(BossE.State.PrepareToShoot);
            }
        }
    }
}
...
namespace Game
{
    ...
    public class StatePrepareToShootBossD : AbstractState<BossD.State, BossD>
    {
        private Vector2 _onEnterPrepareToShootLocalPos;
            

        public StatePrepareToShootBossD(FSM<BossD.State> fsm, BossD owner) : base(fsm, owner)
        { }
        ...
        protected override void OnUpdate()
        {
            ...
            {
                _fsm.ChangeState(BossD.State.Shoot);
            }
        }

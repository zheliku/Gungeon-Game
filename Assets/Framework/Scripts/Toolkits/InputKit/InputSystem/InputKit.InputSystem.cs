...
namespace Framework.Toolkits.InputKit
{
    ...
    public partial class InputKit
    {
        ...
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName];
        }

        public static InputActionMap GetInputActionMap(string actionMapName)
        {
            return InputManager.Instance.ActionMaps[actionMapName];
        }
        ...
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName].BindPerformed(callback);
        }
        ...
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName].BindCanceled(callback);
        }
        ...
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName].BindStarted(callback);
        }
        ...
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName].UnBindPerformed(callback);
        }
        ...
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName].UnBindCanceled(callback);
        }
        ...
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName].UnBindStarted(callback);
        }
        
        public static InputAction UnBindAllPerformed(string actionName, string actionMapName = "Player")
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName].UnBindAllPerformed();
        }

        public static InputAction UnBindAllCanceled(string actionName, string actionMapName = "Player")
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName].UnBindAllCanceled();
        }

        public static InputAction UnBindAllStarted(string actionName, string actionMapName = "Player")
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName].UnBindAllStarted();
        }
        
        public static InputAction UnBindAll(string actionName, string actionMapName = "Player")
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName].UnBindAll();
        }

        public static InputAction ActivateInputAction(string actionName, string actionMapName = "Player")
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName].Activate();
        }

        public static InputAction DeactivateInputAction(string actionName, string actionMapName = "Player")
        {
            return InputManager.Instance.ActionMaps[actionMapName][actionName].Deactivate();
        }
        
        public static InputActionMap ActivateInputActionMap(string actionMapName)
        {
            return InputManager.Instance.ActionMaps[actionMapName].Activate();
        }

        public static InputActionMap DeactivateInputActionMap(string actionMapName)
        {
            return InputManager.Instance.ActionMaps[actionMapName].Deactivate();
        }
